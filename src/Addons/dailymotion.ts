...
dailymotionAddon.registerActionHandler("catalog", async (input, ctx) => {
...
dailymotionAddon.registerActionHandler("item", async (input, ctx) => {
...
dailymotionAddon.registerActionHandler("source", async (input, ctx) => {
	console.log(input);
	return [
...
dailymotionAddon.addResolveHandler(
